 ...
 * - $total_count: The total number of submissions to this loisform.
...
<?php if (count($table['#rows'])): ?>
  <?php print theme('loisform_results_per_page', $total_count, $pager_count); ?>
...
<?php if ($is_submissions): ?>
  <?php print theme('links', array('loisform' => array('title' => t('Go back to the form'), 'href' => 'node/' . $node->nid))); ?>
<?php endif; ?>
